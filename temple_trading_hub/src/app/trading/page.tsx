...
const trading = () => {
    ...
    return (
        <div>
            ...
            <div>
                {!user ? null : (
                    <Grid container justifyContent="center" alignItems="center" direction="column" spacing={2} marginTop="20px">
                        <Button variant="contained">
                            <Link href={"/createtrade"}>Create Trade</Link>
                        </Button>
                    </Grid>
                )}
            </div>
            <div className={styles.trading_content}>
                ...
                <Item
                    imageUrl={airp}
                    item_name="Airpod Pros"
                    item_condition="used"
                />
                <Item
                    imageUrl={rila}
                    item_name="Rilakuma - pancake"
                    item_condition="used"
                />
                <Item
                    imageUrl={mac}
                ...
                <Item
                    imageUrl={phl}
                    item_name="Phillies Jersey"
                    item_condition="used"
                />
                <Item
                    imageUrl={Rmouse}
                    item_name="Razer mouse"
                    item_condition="used"
                />
                <Item
                    imageUrl={Aguitar}
